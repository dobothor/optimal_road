...
def savep():
    ...
    #print(image_b64)
    image_PIL = Image.open(BytesIO(base64.b64decode(image_b64))).convert('RGB')  #https://stackoverflow.com/questions/53722390/bytesio-replaces-transparency-in-png-files-with-black-background
